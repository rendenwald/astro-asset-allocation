...
title: Bold Asset Allocation (BAA)
...
[Bold Asset Allocation - Overfitted](./results/bold-asset-allocation-overfitted.html)<br />
...
* Assets universes (3): offensive, defenssive, canary
...
* Momentum indicator - offenssive and defenssive universe: [SMA12](../indicators/momentum#momentum-sma12)
...
If any of canary assets have negative momentum then select 3 asset from defenssive assets with highest relative momentum.
