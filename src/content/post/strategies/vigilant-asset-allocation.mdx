...
title: Vigilant Asset Allocation (VAA)
...
<DListItem dt="13612W momentum filter">
  ...
  [13612W Momentum description](../indicators/momentum).
</DListItem>
...
* Assets universes (2): offensive, defenssive
    * Offenssive universe (12): 
        ...
        * ✨ **GSG** - Commodity - Gold - SPDR Gold Trust
        * ✨ **GLD** - Commodity - Diversified - iShares S&P GSCI Commodity-Indexed Trust
...
[Vigilant Asset Allocation G12 - Balanced](./results/vigilant-asset-allocation-g12-balanced.html)