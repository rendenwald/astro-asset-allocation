...
Originally written by Wouter J. Keller and Jan Willem Keuning in 2017 in this paper: [Breadth Momentum and Vigilant Asset Allocation (VAA): Winning More by Losing Less](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3002624).
